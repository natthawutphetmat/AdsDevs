...
<nav className="navbar navbar-expand-lg navbar-dark bg-primary" aria-label="Ninth navbar example">
    <div className="container-xl">
      ...
      <div className="collapse navbar-collapse" id="navbarsExample07XL">
        ...
        <a href="https://lin.ee/Mq3D4ok"><img src="https://scdn.line-apps.com/n/line_add_friends/btn/th.png" alt="เพิ่มเพื่อน" height="36" border="0"/></a>
